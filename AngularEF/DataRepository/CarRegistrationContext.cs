 ...
 * Ownership (AutoCreated as 1-n against Person and n-1 against Car)
 * 
 * Cardinality
 ...
 * n-m Ownership -> Car Many to many relation. many cars can owned by many owners. Many owners can own many cars
 * 
 * 
*/
